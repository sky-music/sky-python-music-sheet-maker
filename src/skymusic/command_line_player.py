...
SONG_DIR_IN = os.path.normpath(os.getenv("SONG_INPUT_DIR")) if os.getenv("SONG_INPUT_DIR") is not None else os.path.join(USER_FILES_ROOT, 'test_songs') # Overrides defaut input song folder
if not os.path.isdir(SONG_DIR_IN):
    os.makedirs(SONG_DIR_IN)
SONG_DIR_OUT = os.path.normpath(os.getenv("SONG_OUTPUT_DIR")) if os.getenv("SONG_OUTPUT_DIR") is not None else os.path.join(USER_FILES_ROOT, 'songs_out') # Overrides defaut output song folder
