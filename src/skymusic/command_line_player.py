...
SONG_DIR_IN = os.path.normpath(os.getenv("SONG_INPUT_DIR")) if os.getenv("SONG_INPUT_DIR") != None else os.path.normpath(PROJECT_ROOT + '/test_songs') # Overrides defaut input song folder
SONG_DIR_OUT = os.path.normpath(os.getenv("SONG_OUTPUT_DIR")) if os.getenv("SONG_OUTPUT_DIR") != None else  os.path.normpath(PROJECT_ROOT + '/songs_out') # Overrides defaut output song folder
