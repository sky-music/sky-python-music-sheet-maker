...
class Communicator:
    ...
    def __init__(self, owner_name=None):
        ...
        self.standard_queries['song_creation'] = {'class': communication.QueryOpen.__name__, 'sender': owner_name, 'recipient': 'music-sheet-maker', 'question': 'Please create a Visual Sheet'}
    ...
    def __str__(self):
        ...
        return '<' + self.__class__.__name__ + ' of ' + repr(self.owner_name) + ' with ' + str(len(self.memory)) + ' stored queries>'
