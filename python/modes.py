...
class InputMode(Enum):
    SKYKEYBOARD = (1, "input_mode/skykeyboard/short_desc", "input_mode/skykeyboard/long_desc", noteparsers.skykeyboard.SkyKeyboard)
    ...
    ENGLISHCHORDS = (6, "input_mode/englishchords/short_desc", "input_mode/englishchords/long_desc", noteparsers.englishchords.EnglishChords)
